    ...
    <div className="home-body">
      ...
      <Row gutter={[16, 16]} className="row">
        <Col
          ...
          className="Col"
        >
          <Card className="cards" cover={<img alt="example" src={pharmacy} />}>
        ...
        >
          <Card className="cards" cover={<img alt="example" src={dairy} />}>
            ...
            <div className="card-product-content">Include it in your meal</div>
          </Card>
        </Col>
        <Col
          xs={{ span: 24 }}
        ...
        <Col
          ...
          className="Col"
        >
          <Card className="cards" cover={<img alt="example" src={cleaning} />}>
            <div className="card-product-name">Cleaning & laundry</div>
            <div className="card-product-content">A life full of Whiteness</div>
          </Card>
        </Col>
        <Col
          xs={{ span: 24 }}
          ...
          className="Col"
        >
          <Card className="cards" cover={<img alt="example" src={skincare} />}>
